...
def main():
    ...
    while True:
        ...
        if tvecs_list and x and y and z and detected and dist and angle is not None:
            ...
            cv2.putText(frame, f"Data: {data}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
            cv2.putText(frame, f" Avg Data: {avg_data}", (10, 130), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 0, 0), 2)
